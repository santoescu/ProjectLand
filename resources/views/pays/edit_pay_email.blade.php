<x-layouts.appEmail :title="__('Payable')">
    ...
    <form method="POST" action="{{ route('pays.updateEmail', ['id' => $pay->_id, 'user_id' => $user->_id]) }}" class="space-y-4 max-w-xl mx-auto">
        ...
        @php
            ...
            if (empty($existingAllocations) && filled($pay->contract_id) && filled($pay->chartAccount_id)) {
                $existingAllocations = [[
        ...
        @endphp
        @php
            $initialProjectId = (string) $selectedProjectId;
